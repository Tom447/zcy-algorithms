...
![](images/WEBRESOURCE9a331c47474f40cf95aa7c1f28ac9b06image.png)

![](images/WEBRESOURCEd8fb911c392d44539531f65661d53bc9image.png)

举例

![](images/WEBRESOURCEa59260cb9fa141b7951ec71f48d30601image.png)

![](images/WEBRESOURCE4816b6abeaf7422fac0074894bd1a5ecimage.png)
...
![](images/WEBRESOURCE3fcc576571b14e0a938f7944aa547b4fimage.png)

加入参数后发现可能性太多了

![](images/WEBRESOURCEbd1058b4a2534e6eb18ec9d721033870image.png)

潜台词是：L-1，R+1没爆的时候，调用f(L, R)之前

![](images/WEBRESOURCEe191aff67104493b80f52dca449a9f27image.png)

这个时候调用f（L, R）的时候，可以认为0和5处的气球都没有爆

![](images/WEBRESOURCE9fb61e84ee8e4422ae077d997594ffe4image.png)
...
![](images/WEBRESOURCE8bb3953f5e7646519ad47f83187f707fimage.png)
...
![](images/WEBRESOURCEaceda8fbe15f4869834272d8ae98208eimage.png)

通过各种尝试来使得f中的参数尽可能的少

如果发现尝试的参数越来越多了，那么就说明尝试的方式有问题

![](images/WEBRESOURCEf5f7394c227b42f2be2b66134b94a3e9image.png)
...
![](images/WEBRESOURCE748e72b8d1264b63a298d4cf7ec07da4image.png)

连续消的个数*个数的最大值，一起消掉的前提是数字需要一样

![](images/WEBRESOURCEfd0c66990f114b3e8e4138fa6fb903baimage.png)

f的含义是x紧贴着的5个x，arr13到29位置上的函数消掉最大值是多少

![](images/WEBRESOURCE8b452f90e37a4547aa4e4253a4860d86image.png)

![](images/WEBRESOURCE38d075149f82445dab1569349aca341dimage.png)
...
![](images/WEBRESOURCE00961a0ee3e549e69a482ec368327dc2image.png)

通过这种方法来解决所有可能性

![](images/WEBRESOURCEaf7e2fbcbad74c34ab43122b826cc87dimage.png)

第一种可能性是前面k个x是和L位置的x一起消去的

![](images/WEBRESOURCEe5453ac4bfaf44f4b1f9417edec0f55dimage.png)
...
![](images/WEBRESOURCEb9036dab16a84950ad89821650c8b11aimage.png)

优化部分

![](images/WEBRESOURCE2d23b8583e2548e0a3912019e48ed11cimage.png)

连续的1放一起

![](images/WEBRESOURCE33f82435117b41ed8717d4e1eab6938cimage.png)

开头一样的部分只试最后一个

中间连成一片的只试第一个

![](images/WEBRESOURCEeed4465063f6417399fe5aa5392d4454image.png)
...
![](images/WEBRESOURCE978ee601392549929f5ee7fe144f3830image.png)

前面部分相同的按一个来算

![](images/WEBRESOURCE9fecbc4cea5b4ba880a774f9c7322f13image.png)

前面的pre个1是跟着last一起消去的

![](images/WEBRESOURCE20b1301cae534f40a66b59b4403f0cdeimage.png)
...
![](images/WEBRESOURCEd4e4514d77c040a5918e896dad693977image.png)

这道题和第二题一样，不需要知道前面有多少个，只需要知道前面有就可以了

![](images/WEBRESOURCE55ec36a5f2394b6db6befa81f0f2df10image.png)

![](images/WEBRESOURCEaced36293a394d9ba0e2b6b9d823e80fimage.png)

![](images/WEBRESOURCE15fbf7155d014109ae356b144793c48aimage.png)

上面是三个分支

![](images/WEBRESOURCE7bf44df64a28427090604243290ec709image.png)

![](images/WEBRESOURCEd0db5e34dcca463bb2dc241dbfb57583image.png)
...
![](images/WEBRESOURCE5ffda2fe07a046f4ae05aa26cbe23148image.png)

每道题尝试都不一样

![](images/WEBRESOURCE93386b247a4242f2a42e5a8bcc6852cdimage.png)
...
![](images/WEBRESOURCE720b87325bb34a12ab81ec7e84cee3f7image.png)
...
![](images/WEBRESOURCEe5f3639bbba74b278d0a34169f28ad84image.png)
